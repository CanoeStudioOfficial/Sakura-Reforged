...
public class SakuraFluidTagsProvider extends FluidTagsProvider {
    ...
    public SakuraFluidTagsProvider(DataGenerator datagen, CompletableFuture<HolderLookup.Provider> provider, String modId, ExistingFileHelper existingFileHelper) {
        super(datagen.getPackOutput(),provider, modId, existingFileHelper);
    }
    @Override
